     ...
     <tr>
      <td valign="top">
       <table cellpadding="0" cellspacing="0" align="center" class="es-content">
         <tr>
          <td align="center" class="es-info-area">
               ...
               <table cellpadding="0" cellspacing="0" width="100%">
                 <tr>
                  <td width="560" valign="top" align="center" class="es-m-p0r">
                   <table cellpadding="0" cellspacing="0" width="100%">
                     <tr>
                      <td align="center" class="es-p20b" style="font-size:0px"><amp-img src="https://etyhars.stripocdn.email/content/guids/CABINET_887f48b6a2f22ad4fb67bc2a58c0956b/images/93351617889024778.png" alt="Logo" width="200" title="Logo" style="display:block;font-size:12px" height="48"></amp-img></td>
                     </tr>
                     <tr>
                      <td>
                       <table cellpadding="0" cellspacing="0" width="100%" class="es-menu">
                         <tr class="links">
                          <td align="center" valign="top" width="25%" class="es-p10t es-p10b es-p5r es-p5l" style="padding-top:15px;padding-bottom:15px">
                           <div>
                            <a target="_blank" href="https://">Shop</a>
                           </div></td>
                          <td align="center" valign="top" width="25%" class="es-p10t es-p10b es-p5r es-p5l" style="padding-top:15px;padding-bottom:15px">
                           <div>
                            <a target="_blank" href="https://">New</a>
                           </div></td>
                          <td align="center" valign="top" width="25%" class="es-p10t es-p10b es-p5r es-p5l" style="padding-top:15px;padding-bottom:15px">
                           <div>
                            <a target="_blank" href="https://">Sale</a>
                           </div></td>
                          <td align="center" valign="top" width="25%" class="es-p10t es-p10b es-p5r es-p5l" style="padding-top:15px;padding-bottom:15px">
                           <div>
                            <a target="_blank" href="https://">About</a>
                           </div></td>
                         </tr>
                       </table></td>
                     </tr>
         ...
         <tr>
          <td align="center">
           <table bgcolor="#ffffff" align="center" cellpadding="0" cellspacing="0" width="600" class="es-content-body">
             <tr>
              <td align="left" class="es-p30t es-p30b es-p20r es-p20l">
               <table cellpadding="0" cellspacing="0" width="100%">
                 <tr>
                  <td width="560" align="center" valign="top">
                   <table cellpadding="0" cellspacing="0" width="100%">
                     <tr>
                      <td align="center" class="es-p10t es-p10b" style="font-size:0px"><amp-img src="https://etyhars.stripocdn.email/content/guids/CABINET_67e080d830d87c17802bd9b4fe1c0912/images/55191618237638326.png" alt="" width="100" style="display:block" height="72"></amp-img></td>
                     </tr>
                     <tr>
                      <td align="center" class="es-p10b"><h1 class="es-m-txt-c" style="font-size:46px;line-height:46px">Confirm Your Email</h1></td>
                     </tr>
                     <tr>
                     ...
                     <tr>
                      <td align="center" class="es-p10t es-p10b"><span class="es-button-border" style="border-radius:6px">
                      <a href="{{link_verify}}" target="_blank" class="es-button" style="padding-left:30px;padding-right:30px;border-radius:6px">
                        CONFIRM YOUR EMAIL
                      </a></span></td>
                     </tr>
                     <tr>
                     ...
                     <tr>
                      <td align="center" class="es-p15t es-p15b" style="font-size:0">
                       <table cellpadding="0" cellspacing="0" class="es-table-not-adapt es-social">
                         <tr>
                          <td align="center" valign="top" class="es-p40r"><amp-img title="Facebook" src="https://etyhars.stripocdn.email/content/assets/img/social-icons/logo-black/facebook-logo-black.png" alt="Fb" width="32" height="32"></amp-img></td>
                          <td align="center" valign="top" class="es-p40r"><amp-img title="X" src="https://etyhars.stripocdn.email/content/assets/img/social-icons/logo-black/x-logo-black.png" alt="X" width="32" height="32"></amp-img></td>
                          <td align="center" valign="top" class="es-p40r"><amp-img title="Instagram" src="https://etyhars.stripocdn.email/content/assets/img/social-icons/logo-black/instagram-logo-black.png" alt="Inst" width="32" height="32"></amp-img></td>
                          <td align="center" valign="top"><amp-img title="Youtube" src="https://etyhars.stripocdn.email/content/assets/img/social-icons/logo-black/youtube-logo-black.png" alt="Yt" width="32" height="32"></amp-img></td>
                         </tr>
                       </table></td>
                     </tr>
                     <tr>
                       ...
                       <table cellpadding="0" cellspacing="0" width="100%" class="es-menu">
                         <tr class="links">
                          <td align="center" valign="top" width="33.33%" class="es-p10t es-p10b es-p5r es-p5l" style="padding-top:5px;padding-bottom:5px">
                           <div>
                            <a target="_blank" href="https://" style="color:#999999">Visit Us </a>
                           </div></td>
                          <td align="center" valign="top" width="33.33%" class="es-p10t es-p10b es-p5r es-p5l" style="padding-top:5px;padding-bottom:5px;border-left:1px solid #cccccc">
                           <div>
                            <a target="_blank" href="https://" style="color:#999999">Privacy Policy</a>
                           </div></td>
                          <td align="center" valign="top" width="33.33%" class="es-p10t es-p10b es-p5r es-p5l" style="padding-top:5px;padding-bottom:5px;border-left:1px solid #cccccc">
                           <div>
                            <a target="_blank" href="https://" style="color:#999999">Terms of Use</a>
                           </div></td>
                         </tr>
                       </table></td>
                     </tr>
